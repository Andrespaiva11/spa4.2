    ...
    <FooterContainer>
      <Container>
        <FooterGrid>
          <FooterBrand>
            <h3>✦ María Bonita</h3>
            <p>Tu tienda y academia de maquillaje profesional. Resaltamos tu belleza natural con productos premium, talleres de automaquillaje y servicios exclusivos.</p>
            <SocialLinks>
        ...
        <BottomBar>
          <span>© {year} María Bonita. Todos los derechos reservados.</span>
