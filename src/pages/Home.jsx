    ...
    <>
      ...
      <HeroSection>
        ...
        <HeroContent>
          ...
          <HeroTitle>
            Bienvenido a<br /><span>María Bonita</span>
          </HeroTitle>
          <HeroSubtitle>
            Tu tienda y academia de maquillaje profesional. Descubre nuestros servicios exclusivos de belleza, cursos de automaquillaje y agenda tu cita hoy mismo.
          </HeroSubtitle>
          {!isAuthenticated ? (
            <ButtonGroup>
      ...
      <Section>
        <SectionHeader>
          ...
          <SectionTitle>Expertos en Belleza</SectionTitle>
          <SectionSubtitle>
            Nos dedicamos a resaltar tu belleza natural con las mejores marcas, técnicas de vanguardia y profesionales del sector.
          </SectionSubtitle>
        </SectionHeader>
        ...
        <FeaturesGrid>
          <FeatureCard>
            ...
            <FeatureText>
              Utilizamos cosméticos de alta gama que cuidan, protegen y embellecen tu piel y rostro.
            </FeatureText>
          </FeatureCard>
          <FeatureCard>
      ...
      <Section style={{ paddingTop: 0 }}>
        <CardContainer>
          <DarkCard>
            ...
            <CardText $isDark>
              Explora nuestra gama de especialidades: maquillaje social, de novia, lifting de pestañas, diseño de cejas y cursos de automaquillaje.
            </CardText>
          ...
          <LightCard>
            ...
            <CardText>
              ¿Lista para lucir espectacular? Agendar tu cita es fácil y rápido. Selecciona tu servicio, profesional y horario favorito.
            </CardText>
            {isAuthenticated ? (
        ...
        <ContactWrapper id="contact-section">
          ...
          <ContactGrid>
            ...
            <ContactCard>
              ...
              <ContactCardText>
                <span>Email</span>
                <a href="mailto:contacto@mariabonita.com">contacto@mariabonita.com</a>
              </ContactCardText>
            </ContactCard>
            <ContactCard>
          ...
          <MapContainer>
            ...
            <MapIframe
              title="Ubicación María Bonita - Neiva"
