...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .card {
      background: linear-gradient(145deg, #1f1214, #12090b);
      border: 2px solid rgba(183, 110, 121, 0.45);
      border-radius: 24px;
      padding: 3rem 2.5rem;
      box-shadow: 0 20px 60px rgba(0,0,0,0.6), inset 0 1px 0 rgba(212, 175, 55, 0.15);
      position: relative;
      overflow: hidden;
    }
    ...
    .card::before {
      ...
      right: 0;
      height: 3px;
      background: linear-gradient(90deg, transparent, #B76E79, #D4AF37, #B76E79, transparent);
    }
  ...
  <div class="container">
    <div class="card">
      <div class="brand">
        ...
        <div class="brand-name">María Bonita</div>
        <div class="brand-sub">Maquillaje Profesional &amp; Academia</div>
      </div>
      ...
      <div class="footer">
        <p class="footer-text">
          ¡Gracias por confiar en <span class="footer-highlight">María Bonita</span>!<br>
          Te esperamos para realzar tu belleza.
        </p>
